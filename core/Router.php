...
final class Router
{
    ...
    private function debugRouting()
    {
        echo '<p><span style="color: white; background: green;">Маршрут найден</span><br>';
        echo 'controller: <b>'. $this->params['controller'] . '</b><br>';
        echo 'action: <b>'. $this->params['action'] . '</b></p>';
    }
}